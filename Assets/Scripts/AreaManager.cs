...
public class AreaManager : MonoBehaviour
{
  ...
  protected  int areaLength;
    ...
    public virtual void GenerateMap()
    {
        ...
        for (int i = 0; i < 5; i++) { layer[i].empty = true; }//lengthëwñ⁄ ãxåe
        layer[2].empty = false;
        ...
        for (int i = 0; i < 5; i++) { layer[i].empty = true; }//length+1ëwñ⁄ É{ÉX
        layer[2].empty = false;
        layer[2] = SetRoom(false, true);
        layer[2].up = -1;
        layer[2].straight = 2;
        ...
        for (int i = 0; i < 5; i++) { layer[i].empty = true; }//length+2ëwñ⁄(ÉGÉäÉAÇÃèIí[)
        layer[2].empty = false;
        layer[2].up = -1;
        layer[2].straight = -1;
        layer[2].down = -1;
